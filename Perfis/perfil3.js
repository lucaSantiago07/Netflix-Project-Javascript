...
window.onload = function (){
  ...
  let imagemPerfil = document.getElementById('imagem')
    imagemPerfil.src = louco[3]
    imagemPerfil.className = "images"
    
    switch (Number(yearStorage[1])) {
      case 1:
...
function changeImage() {
  ...
  console.log(yearsKey[1])
    switch(Number(yearsKey[1])){
      case 1: 
...
function save() {
  ...
  let saveButton = document.getElementById('Salvar')
    ...
    perfilStorages[2] = nameInput.value
    perfilStorages[3] = imagemPerfil.src
...
function deleted() {
  ...
  perfilStoragesDel[2] = 'New Perfil'
  perfilStoragesDel[3] = '../profile-images/new-perfil-image.png'
