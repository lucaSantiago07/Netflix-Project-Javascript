...
window.onload = function (){
  ...
  let imagemPerfil = document.getElementById('imagem')
    imagemPerfil.src = louco[5]
    imagemPerfil.className = "images"
    
    switch (Number(yearStorage[2])) {
      case 1:
...
function changeImage() {
  ...
  console.log(yearsKey[2])
    switch(Number(yearsKey[2])){
      case 1: 
...
function save() {
  ...
  let saveButton = document.getElementById('Salvar')
    ...
    perfilStorages[4] = nameInput.value
    perfilStorages[5] = imagemPerfil.src
...
function deleted() {
  ...
  perfilStoragesDel[4] = 'New Perfil'
  perfilStoragesDel[5] = '../profile-images/new-perfil-image.png'
