...
window.onload = function (){
  ...
  let imagemPerfil = document.getElementById('imagem')
    imagemPerfil.src = louco[7]
    imagemPerfil.className = "images"
    
    switch (Number(yearStorage[3])) {
      case 1:
...
function changeImage() {
  ...
  console.log(yearsKey[3])
    switch(Number(yearsKey[3])){
      case 1: 
...
function save() {
  ...
  let saveButton = document.getElementById('Salvar')
    ...
    perfilStorages[6] = nameInput.value
    perfilStorages[7] = imagemPerfil.src
...
function deleted() {
  ...
  perfilStoragesDel[6] = 'New Perfil'
  perfilStoragesDel[7] = '../profile-images/new-perfil-image.png'
