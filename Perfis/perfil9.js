...
window.onload = function (){
  ...
  let imagemPerfil = document.getElementById('imagem')
    imagemPerfil.src = louco[9]
    imagemPerfil.className = "images"
    
    switch (Number(yearStorage[4])) {
      case 1:
...
function changeImage() {
  ...
  console.log(yearsKey[4])
    switch(Number(yearsKey[4])){
      case 1: 
...
function save() {
  ...
  let saveButton = document.getElementById('Salvar')
    ...
    perfilStorages[8] = nameInput.value
    perfilStorages[9] = imagemPerfil.src
...
function deleted() {
  ...
  perfilStoragesDel[8] = 'New Perfil'
  perfilStoragesDel[9] = '../profile-images/new-perfil-image.png'
